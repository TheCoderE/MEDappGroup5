...
with open(r'c:\Users\sarah\PycharmProjects\pythonSummerSchool\Project\test2.csv', 'r') as fin:   # add own file path
...
def check_cabinet():
    ...
    answer_barcode = input()                    # checks inventory if barcode is already available
    ...
    print('The expiration_date is', ex_date)
    if today > ex_date:
